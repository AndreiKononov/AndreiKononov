...
@NgModule({
    ...
    declarations:   [ AppComponent, AppComponent2, AppComponent3, AppComponent4, AppComponent5 ],
    // root component(s) (run(s) by default when this app starts running)
    bootstrap:      [ AppComponent, AppComponent2, AppComponent3, AppComponent4, AppComponent5 ],
