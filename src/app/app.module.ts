...
@NgModule({
    ...
    declarations:   [ AppComponent, ChildComponent ], // set of view classes of current module (There are three type of view classes in Angular: components, directives, pipes)
